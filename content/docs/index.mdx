...
title: Tina Docs
last_edited: '2025-04-29T02:21:41.656Z'
next: content/docs/core-concepts/overview.mdx
previous: ''
---
...
<cardGrid
  cards={[
    ...
    { title: "Test", description: "some text" },
    { title: "Test", description: "some more text" },
    {
      title: "This is a really long title.",
      description:
        "This is also a long bit of text just to check everything moves as expected."
    },
    { title: "Grid business.", description: "Grid business..." }
  ]}
/>
  ...
  property={[
    {
      ...
      required: true,
      experimental: true,
      description: "This is some example text on how this works\n"
    },
...
Tina enables developers to craft a custom visual editing experience perfectly tailored to their website or application while supporting a broad range of content types such as Markdown, MDX, and JSON.
