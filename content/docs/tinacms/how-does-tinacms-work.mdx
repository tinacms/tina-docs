...
![](</Untitled design (8).png> "Access the content portal on the /admin/index.html route of your website")
...
![](</Untitled design (9).png> "Data moves from GitHub to your website via the TinaCMS Backend")
