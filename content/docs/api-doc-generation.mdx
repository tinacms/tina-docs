...
![](</Untitled design (20).png> "Uploading a spec via the API Schema collection")
...
![](</Untitled design (21).png> "Selecting a specific endpoint from the API Reference component")
...
![](</Untitled design (22).png> "Generating a menu group and pages from a specification")
