...
<imageEmbed image={{ src: "/img/landing-assets/tinacms-github-integration.jpg", alt: "Diagram showing TinaCMS integration with GitHub for content storage and version control" }} caption="Keep everything in GitHub" />
