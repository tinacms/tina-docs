...
<imageEmbed image={{ src: "/img/docs-assets/collections-menu-access.png", alt: "TinaCMS sidebar showing the collections menu with a list of documentation pages" }} caption="Accessing a specific page via the collections menu" />
...
<imageEmbed image={{ src: "/img/docs-assets/edit-route-navigation.png", alt: "Browser URL bar showing how to navigate to the edit route by inserting /admin/#/~/ into the URL" }} caption="Going to the edit route on a particular URL" />
...
<imageEmbed image={{ src: "/img/docs-assets/add-new-page-collections.png", alt: "TinaCMS collections menu with the Add File button to create a new documentation page" }} caption="Adding a new page via the collections menu" />
...
<imageEmbed image={{ src: "/img/docs-assets/navigation-new-tab.png", alt: "TinaCMS Navigation Bar collection editor showing how to add a new Docs or API tab" }} caption="Adding a new tab via the Navigation Bar collection" />
...
<imageEmbed image={{ src: "/img/docs-assets/menu-tree-structure.png", alt: "TinaCMS Navigation Bar editor showing the nested tree structure of menu items and sub-menus" }} caption="Inside the Tab object exists your menu tree structure" />
