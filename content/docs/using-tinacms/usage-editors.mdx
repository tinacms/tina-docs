...
<preloadedImage
  image={{
    src: "/img/docs-assets/collections-menu-access.png",
    width: 2245,
    height: 1587,
    alt: ""
  }}
  caption="Accessing a specific page via the collections menu"
/>
...
<preloadedImage
  image={{
    src: "/img/docs-assets/edit-route-navigation.png",
    width: 2061,
    height: 1059,
    alt: ""
  }}
  caption="Going to the edit route on a particular URL"
/>
...
<preloadedImage
  image={{
    src: "/img/docs-assets/add-new-page-collections.png",
    width: 2245,
    height: 1587,
    alt: ""
  }}
  caption="Adding a new page via the collections menu"
/>
...
<preloadedImage
  image={{
    src: "/img/docs-assets/navigation-new-tab.png",
    width: 1828,
    height: 1231,
    alt: ""
  }}
  caption="Adding a new tab via the Navigation Bar collection"
/>
...
<preloadedImage
  image={{
    src: "/img/docs-assets/menu-tree-structure.png",
    width: 2245,
    height: 1587,
    alt: ""
  }}
  caption="Inside the Tab object exists your menu tree structure"
/>
