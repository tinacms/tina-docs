...
![TinaCMS sidebar showing the collections menu with a list of documentation pages](/img/docs-assets/collections-menu-access.png "Accessing a specific page via the collections menu")
...
![Browser URL bar showing how to navigate to the edit route by inserting /admin/#/~/ into the URL](/img/docs-assets/edit-route-navigation.png "Going to the edit route on a particular URL")
...
![TinaCMS collections menu with the Add File button to create a new documentation page](/img/docs-assets/add-new-page-collections.png "Adding a new page via the collections menu")
...
![TinaCMS Navigation Bar collection editor showing how to add a new Docs or API tab](/img/docs-assets/navigation-new-tab.png "Adding a new tab via the Navigation Bar collection")
...
![TinaCMS Navigation Bar editor showing the nested tree structure of menu items and sub-menus](/img/docs-assets/menu-tree-structure.png "Inside the Tab object exists your menu tree structure")
