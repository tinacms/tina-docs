...
![TinaCMS admin portal showing the visual editing interface at the /admin/index.html route](/img/docs-assets/tinacms-admin-portal.png "Access the content portal on the /admin/index.html route of your website")
...
![Diagram showing data flow from GitHub through the TinaCMS backend GraphQL API to the website](/img/docs-assets/tinacms-data-flow.png "Data moves from GitHub to your website via the TinaCMS Backend")
