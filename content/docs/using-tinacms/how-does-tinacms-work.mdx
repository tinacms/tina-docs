...
<imageEmbed image={{ src: "/img/docs-assets/tinacms-admin-portal.png", alt: "TinaCMS admin portal showing the visual editing interface at the /admin/index.html route" }} caption="Access the content portal on the /admin/index.html route of your website" />
...
<imageEmbed image={{ src: "/img/docs-assets/tinacms-data-flow.png", alt: "Diagram showing data flow from GitHub through the TinaCMS backend GraphQL API to the website" }} caption="Data moves from GitHub to your website via the TinaCMS Backend" />
