...
![TinaCMS redirect editor showing source path, destination path, and permanent redirect toggle](/img/docs-assets/redirect-editor-interface.png "Adding a redirect via the editor")
