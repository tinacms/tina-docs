...
<imageEmbed image={{ src: "/img/docs-assets/redirect-editor-interface.png", alt: "TinaCMS redirect editor showing source path, destination path, and permanent redirect toggle" }} caption="Adding a redirect via the editor" />
