...
<imageEmbed image={{ src: "/img/docs-assets/embed-toolbar-access.png", alt: "TinaCMS rich-text editor toolbar showing the embed tab" }} caption="Access the embed tab of the toolbar." />
