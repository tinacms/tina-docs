...
Multiple embedded components – accordions, callouts, and cards are available out of the box.
...
![TinaCMS rich-text editor toolbar showing the embed tab](/img/docs-assets/embed-toolbar-access.png "Access the embed tab of the toolbar.")
