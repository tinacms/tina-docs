...
<imageEmbed image={{ src: "/img/docs-assets/choose-starter-screen.png", alt: "TinaDocs theme selection screen showing six colour presets" }} caption="Choose your starter" />
