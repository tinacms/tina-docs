...
<imageEmbed image={{ src: "/img/docs-assets/api-spec-upload.png", alt: "TinaCMS API Schema collection interface for uploading an OpenAPI specification" }} caption="Uploading a spec via the API Schema collection" />
...
<imageEmbed image={{ src: "/img/docs-assets/api-endpoint-selection.png", alt: "API Reference component dropdown showing available endpoints from an OpenAPI spec" }} caption="Selecting a specific endpoint from the API Reference component" />
...
<imageEmbed image={{ src: "/img/docs-assets/menu-generation-from-spec.png", alt: "TinaCMS interface generating navigation menu groups and pages from an OpenAPI specification" }} caption="Generating a menu group and pages from a specification" />
