...
<imageEmbed image={{ src: "/img/docs-assets/seo-configuration.png", alt: "TinaCMS SEO configuration panel showing fields for title, description, and Open Graph settings" }} />
