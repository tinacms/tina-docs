...
last_edited: '2025-07-30T02:35:05.146Z'
auto_generated: false
---

TinaDocs utilizes **NextJS** to build your sitemap at build time.

By default, the path is controlled by the filepath of each document, with one special case for the home route.
