...
last_edited: '2025-05-12T06:46:27.027Z'
tocIsHidden: true
next: ''
previous: ''
---
...
<apiReference
  ...
  pathParameters={[
    {
      parameterName: "id",
      parameterDescription: "The ID of the user",
      required: true,
      in: "path",
      type: "string"
    },
    {
      parameterName: "includePosts",
      parameterDescription: "Whether to include the user's posts.",
      in: "query",
      type: "boolean"
    }
  ]}
  responses={[
    {
      ...
      responseBody: [
        ...
        },
        {
          ...
          fields: [
            { fieldName: "bio", type: "string", description: "Short biography" },
            {
              fieldName: "avatarUrl",
              type: "string",
    ...
    },
    {
      ...
      responseBody: [
        { fieldName: "error", type: "string", description: "Error message." }
      ]
    }
  ]}
/>
