  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'brand-secondary-gradient-start': 'var(--brand-secondary-gradient-start)',
        ...
        'background-primary-gradient-start': 'var(--background-primary-gradient-start)',
        'background-primary-gradient-end': 'var(--background-primary-gradient-end)',
