import AccordionTemplate, { AccordionBlockTemplate } from "@/tina/templates/markdown-embeds/accordion.template";
import TypeReferenceTemplate from "@/tina/templates/markdown-embeds/type-reference.template";
  ...
  fields: [
    ...
    },
    {
      ...
      templates: [
        ...
        TypeReferenceTemplate as Template,
