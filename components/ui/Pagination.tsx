      ...
      {prevPage && prevPage.slug && (
        <DynamicLink href={prevPage.slug} passHref>
          ...
          >
            ...
            <h5 className="text-base md:text-xl leading-[1.3] m-0 pl transition-all ease-out duration-150 text-secondary-end group-hover:text-primary-via flex items-center">
              <NextImage
                src="/svg/right-arrow.svg"
                alt="Right arrow"
                width={28}
                height={28}
                className="w-7 h-7 fill-gray-400 transition-all ease-out duration-150 rotate-180 group-hover:fill-primary-via mr-2"
              />
              {prevPage.title}
            </h5>
          </div>
      ...
      {nextPage && nextPage.slug && (
        <DynamicLink href={nextPage.slug} passHref>
          ...
          >
            ...
            <h5 className="text-base md:text-xl leading-[1.3] m-0 transition-all ease-out duration-150 text-secondary-end group-hover:text-primary-via flex items-center justify-end">
              {nextPage.title}
              <NextImage
                src="/svg/right-arrow.svg"
                alt="Right arrow"
                width={28}
                height={28}
                className="w-7 h-7 fill-gray-400 transition-all ease-out duration-150 group-hover:fill-primary-via ml-2"
              />
            </h5>
          </div>
        </DynamicLink>
