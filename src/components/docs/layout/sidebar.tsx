...
export const Sidebar = ({
  ...
  return (
    <div className="sticky hidden lg:block mr-4 h-[calc(100vh-8rem)] w-84 ml-8 top-4 rounded-2xl dark:border dark:border-neutral-border-subtle/60 shadow-xl brand-glass-gradient">
