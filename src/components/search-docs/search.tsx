    ...
    <div className="relative w-full md:max-w-sm ml-auto lg:my-4 lg:mb-4">
      <div className={`relative md:mr-4 ${className || ""}`}>
        <input
          type="text"
          value={searchTerm}
          className={`w-full text-neutral-text p-1 lg:p-2 pl-6 rounded-full bg-neutral-background-secondary shadow-lg border border-transparent dark:border-neutral-border-subtle focus:outline-none focus:ring-1 focus:ring-[#0574e4]/50 focus:border-[#0574e4]/50 transition-all ${
